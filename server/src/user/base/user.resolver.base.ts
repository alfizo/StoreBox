...
import { ReceivingFindManyArgs } from "../../receiving/base/ReceivingFindManyArgs";
...
export class UserResolverBase {
  ...
  @graphql.ResolveField(() => [Receiving])
  @nestAccessControl.UseRoles({
    resource: "User",
    action: "read",
    possession: "any",
  ...
  async receivings(
    ...
    const results = await this.service.findReceivings(parent.id, args);
